...
struct Week2Data {
        ...
        static let week2 = WeekCourseContent(
            ...
            introTextParagraph2: ("", "That so few people stopped was not a demonstration of the cluelessness of these commuters, but how the busyness of our daily life can sometimes prevent us from noticing the beautiful and miraculous world all around us.  #*How many amazingly beautiful things do we miss in a day, simply because of the pace of our lives and the intense focus on getting to the next thing?*#"),
                                             ...
                                             weekVideoURLList: [
                                                ("*The Monkey Business Illusion* ~- Daniel Simons [2 min]~", "https://www.youtube.com/watch?v=ux1cL7tHjlI&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo&index=1"),
                                                ("*Mindful Meditation and the Brain* ~- Shauna Shapiro [6 min]~", "https://www.youtube.com/watch?v=R6hybxLidgA&index=2&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo"),
                                                ("*Measuring Mindfulness* ~- Judson Brewer [7 min]~", "https://www.youtube.com/watch?v=wp9JD4APjSs&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo&index=3"),
                                                ("*Life is Right Now* ~- Jon Kabat-Zinn [16 min]~", "https://www.youtube.com/watch?v=VGtJQNqMXBY&index=4&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo"),
                                                ("*Coming to Our Senses* ~- Jon Kabat-Zinn [16 min]~", "https://www.youtube.com/watch?v=XNvZkepAiMo&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo&index=5"),
                                                ("*All it takes is 10 Mindful Minutes* ~- Andy Puddicombe [10 min]~", "https://www.youtube.com/watch?v=qzR62JJCMBQ&index=6&list=PLbiVpU59JkValOIEIo2Y65mBopHCjKvBo")
            ],
                                             weekReadingURLList: [
                                                ("*Sitting Meditation* ~- Jon Kabat-Zinn [excerpted from Full Catastrophe Living]~", "https://palousemindfulness.com/docs/sittingmeditation.pdf"),
                                                ("*Joshua Bell plays a $3,000,000 violin (and almost nobody notices)*", "https://palousemindfulness.com/docs/joshua-bell.pdf"),
                                                ("*How the Brain Rewires Itself* ~- Sharon Begley~", "https://palousemindfulness.com/docs/brain-rewires.pdf"),
                                                ("*How Meditation Affects the Gray Matter of the Brain* ~- David R. Hamilton, Ph.D.~", "https://palousemindfulness.com/docs/graymatter.pdf")
            ],
                                             supplementalMaterialsURLList: [
                                                ("*Altered Traits* ~book by Daniel Goldman and Richard Davidson~", "https://www.amazon.com/Altered-Traits-Science-Reveals-Meditation/dp/0399184384"),
                                                ("*Why a Neuroscientist Would Study Meditation*  ~video by Willoughby Britton [10 min]~", "https://www.youtube.com/watch?v=ioCY_HKBFOc"),
                                                ("*Neuroscientist Richard Davidson's Wake-Up Call* ~article/video by Huffington Post [5 min]~", "http://www.huffingtonpost.com/entry/the-wake-up-call-that-transformed-neuroscientist-richard-davidsons-life_us_571fcbc4e4b01a5ebde3c0a7"),
                                                ("*How Meditation Can Reshape Our Brains* ~video by Sara Lazar [8 min]~", "https://www.youtube.com/watch?v=m8rRzTtP7Tc"),
                                                ("*Mastering Your Own Mind* ~article by Katherine Ellison~", "https://palousemindfulness.com/docs/mastering.pdf"),
